...
namespace Sales.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller("Alex Grey", "alex@gmail.com", new DateTime(1978, 1, 15), 2200.0, d1);
            Seller s4 = new Seller("Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller("Donald Blue", "donny@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
